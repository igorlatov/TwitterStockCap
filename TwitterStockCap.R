...
consumer_key <- "TVaBwOap5OKA13aOEGTu3zvCm"
consumer_secret <- "yt1Uad06Gb1MOOQh8GIMKqaLVklZshrICImOuIVWEVZpep7h5m"
access_token <- "746366700271058945-qTMvW5daDOD8GoKqOcBxP5jr2Ew0F47"
access_secret <- "Kn31QkLUvKO3QpapJu4FkFqc5EQY165uF93WRt68qVaq7"
...
search <- function(searchterm)
{
  ...
  pos <- scan('positive.txt', what='character', comment.char=';') #folder with positive dictionary
  neg <- scan('negative.txt', what='character', comment.char=';') #folder with negative dictionary
